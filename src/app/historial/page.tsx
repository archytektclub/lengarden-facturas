                                            ...
                                            facturas.map((factura) => (
                                                <React.Fragment key={factura.id}>
                                                    <tr className="hover:bg-surface2/50 transition-colors cursor-pointer" onClick={(e) => toggleRow(factura.id, e)}>
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-mono text-text">{factura.numero}</td>
                                                        <td className="px-6 py-4 text-sm font-medium text-text min-w-[150px]">{factura.cliente}</td>
                                                        <td className="px-6 py-4 text-sm text-text min-w-[200px] hidden md:table-cell" title={factura.descripcion || ""}>{factura.descripcion || "-"}</td>
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-mono text-right text-text">{formatCurrency(factura.monto)}</td>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium sticky right-0 bg-surface shadow-[-4px_0_6px_-2px_rgba(0,0,0,0.05)] border-l border-border">
                                                            <Link href={"/facturas?cliente=" + encodeURIComponent(factura.cliente)} className="text-accent hover:underline text-xs">Ver Facturas</Link>
                                                        </td>
                                                    </tr>
