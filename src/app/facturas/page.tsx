                            ...
                            <table className="min-w-full divide-y divide-border">
                                <thead className="bg-surface2">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-muted uppercase tracking-wider">N° Factura</th>
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-muted uppercase tracking-wider">Cliente</th>
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-muted uppercase tracking-wider hidden md:table-cell">Descripción</th>
                                        <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-muted uppercase tracking-wider">Monto</th>
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-muted uppercase tracking-wider">Estado</th>
                                        <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-muted uppercase tracking-wider sticky right-0 bg-surface2 z-10 shadow-[-4px_0_6px_-2px_rgba(0,0,0,0.05)] border-l border-border">Acción</th>
                                    </tr>
                                </thead>
                                        ...
                                        filteredFacturas.map((factura) => (
                                            <React.Fragment key={factura.id}>
                                                <tr className="hover:bg-surface2/50 transition-colors cursor-pointer" onClick={(e) => toggleRow(factura.id, e)}>
                                                    <td className="px-4 py-2 whitespace-nowrap w-12">
                                                        <input
                                                            type="checkbox"
                                                            className="rounded border-border text-accent focus:ring-accent"
                                                    ...
                                                    <td className="px-4 py-2 whitespace-nowrap text-sm font-mono text-text">{factura.numero}</td>
                                                    <td className="px-4 py-2 text-sm font-medium text-text min-w-[150px]">{factura.cliente}</td>
                                                    <td className="px-4 py-2 text-sm text-text min-w-[200px] hidden md:table-cell" title={factura.descripcion || ""}>{factura.descripcion || "-"}</td>
                                                    <td className="px-4 py-2 whitespace-nowrap text-sm font-mono text-right text-text">{formatCurrency(factura.monto)}</td>
                                                    ...
                                                    <td className="px-4 py-2 whitespace-nowrap text-right text-sm font-medium space-x-2 sticky right-0 bg-surface shadow-[-4px_0_6px_-2px_rgba(0,0,0,0.05)] border-l border-border">
                                                        {factura.estado !== "pagado" && (
                                                            <button
                                                                onClick={() => handlePayClick(factura)}
                                                                className="text-black bg-accent hover:bg-accent/90 px-3 py-1 rounded-md transition-colors text-xs"
                                                            >
                                                                Pagar
                                                            </button>
                                                        )}
